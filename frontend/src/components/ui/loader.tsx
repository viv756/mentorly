    ...
    <div
      ...
      <motion.div
        ...
        <motion.div
          ...
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(239, 68, 68) 90deg, transparent 180deg)`,
        ...
        <motion.div
          className="absolute inset-0 rounded-full"
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(239, 68, 68) 120deg, rgba(239, 68, 68, 0.5) 240deg, transparent 360deg)`,
        ...
        <motion.div
          className="absolute inset-0 rounded-full"
          style={{
            background: `conic-gradient(from 180deg, transparent 0deg, rgba(239, 68, 68, 0.6) 45deg, transparent 90deg)`,
        ...
        <motion.div
          className="absolute inset-0 rounded-full"
          style={{
            background: `conic-gradient(from 270deg, transparent 0deg, rgba(239, 68, 68, 0.4) 20deg, transparent 40deg)`,
        ...
        {/* Dark mode variants - also red */}
        <motion.div
          className="absolute inset-0 rounded-full dark:block hidden"
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(248, 113, 113) 90deg, transparent 180deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 35%, black 37%, black 39%, transparent 41%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 35%, black 37%, black 39%, transparent 41%)`,
            opacity: 0.8,
          }}
        ...
        <motion.div
          className="absolute inset-0 rounded-full dark:block hidden"
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(248, 113, 113) 120deg, rgba(248, 113, 113, 0.5) 240deg, transparent 360deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 42%, black 44%, black 48%, transparent 50%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 42%, black 44%, black 48%, transparent 50%)`,
            opacity: 0.9,
          }}
        ...
        <motion.div
          className="absolute inset-0 rounded-full dark:block hidden"
          style={{
            background: `conic-gradient(from 180deg, transparent 0deg, rgba(248, 113, 113, 0.6) 45deg, transparent 90deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 52%, black 54%, black 56%, transparent 58%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 52%, black 54%, black 56%, transparent 58%)`,
            opacity: 0.35,
          }}
        ...
        <motion.div
          className="absolute inset-0 rounded-full dark:block hidden"
          style={{
            background: `conic-gradient(from 270deg, transparent 0deg, rgba(248, 113, 113, 0.4) 20deg, transparent 40deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 61%, black 62%, black 63%, transparent 64%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 61%, black 62%, black 63%, transparent 64%)`,
            opacity: 0.5,
          }}
